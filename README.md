...
# Ответ: Вот скрин, как и обещал, там собственно все AS. Пробить получилось только 
# root@vagrant:~# grep OrgName <(whois AS15169)
# OrgName:        Google LLC
...
# Ответ: 8.8.8.8.in-addr.arpa.   56540   IN      PTR     dns.google.         
# 4.4.8.8.in-addr.arpa.   37892   IN      PTR     dns.google.
